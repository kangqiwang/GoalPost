...
void LineDetectAlgorithm::createPaddedImg()
{
...
void LineDetectAlgorithm::getPointsAlongTheLine(int iteration)
{
    ...
    {
        if (stepPos != i) 
            continue; //sample points only with interval lineStep
...
void LineDetectAlgorithm::getPointsAlongTheGoalBar()
{
...
void LineDetectAlgorithm::CannyThreshold()
{
...
double LineDetectAlgorithm::objectiveFunction(float const *x)
...
Point2f LineDetectAlgorithm::findTheShift()
{
